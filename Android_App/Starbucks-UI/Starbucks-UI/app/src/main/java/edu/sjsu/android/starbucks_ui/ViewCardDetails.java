...
//    String user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_cardno = (EditText)findViewById(R.id.cardNumberDisplay);
        txt_cardexpiry = (EditText)findViewById(R.id.cardExpiryDisplay);
        txt_cardhname = (EditText)findViewById(R.id.cardHolderDisplay);
        txt_cvv = (EditText)findViewById(R.id.cardCvvDisplay);
        txt_username = (EditText)findViewById(R.id.userDisplay);
        txt_balance = (EditText)findViewById(R.id.balanceDisplay);
...
//               String username = i.getStringExtra("Username");
    ...
    public void openCardActivity(View v){
        Intent intent = new Intent(ViewCardDetails.this, CardActivity.class);
        Bundle bundle = getIntent().getExtras();
        String username = bundle.getString("Username");
